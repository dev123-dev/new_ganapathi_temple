...
class TrustEventGenerationFPDF extends CI_Controller
{
	...
	public function index() {
		...
		if($_POST['posSearch'] != "") {
			$where .= " AND TET_RECEIPT_NAME = '".$_POST['posSearch']."' OR TET_RECEIPT_PHONE = '".$_POST['posSearch']."'";
		}
		...
		$query = "SELECT * FROM POSTAGE INNER JOIN TRUST_EVENT_RECEIPT ON POSTAGE.RECEIPT_ID = TRUST_EVENT_RECEIPT.TET_RECEIPT_ID INNER JOIN TRUST_EVENT ON TRUST_EVENT_RECEIPT.RECEIPT_TET_ID = TRUST_EVENT.TET_ID WHERE TET_ACTIVE = 1 AND ".$where; 
