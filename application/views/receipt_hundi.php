<form id="formSub" action="<?php echo site_url(); ?>Receipt/receipt_hundi_save" enctype="multipart/form-data" method="post" accept-charset="utf-8">
	<div class="container">
		...
		<div class="row form-group">
			...
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
				<a style="width:24px; height:24px" class="pull-right img-responsive" href="<?=site_url()?>Receipt/receipt_hundi" title="Reset"><img title="Reset" src="<?=site_url();?>images/refresh.svg"/></a>
			</div>
		</div>
		...
		<div class="row form-group">
			<div class="sevaDate">	
				<div class="form-inline col-lg-4 col-md-3 col-sm-4 col-xs-12">
				...
				<div <?php if(@$_SESSION['eventActiveCount'] == 0) echo "style='display:none;'"?> class="form-inline col-lg-4 col-md-3 col-sm-4 col-xs-12">
					<div class="form-group">
						<div class="radio pull-left" style="margin-top: 0.3em;">
						  <label class="radio-inline"><input id="events_Radio" type="radio" value="" onclick="GetChangeRadio('event')" name="optradio"> Event</label>
						</div>&nbsp;
	  ...
	  <div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Deity/Event Hundi Preview</h4>
			</div>
