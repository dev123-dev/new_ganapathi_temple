		...
		<form id="tddate" enctype="multipart/form-data" method="post" accept-charset="utf-8">
			<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
				<div class="input-group input-group-sm">
					...
					<input autocomplete="" id="todayDate" type="text" value="<?=@$date; ?>" class="form-control todayDate2" onchange="get_datefield_change(this.value)" placeholder="dd-mm-yyyy" readonly="readonly"/>
			...
			<div class="col-offset-lg-5 col-lg-2 col-md-3 col-sm-12 col-xs-12 pull-right text-right">
				...
				<?php } ?>
				<a style="margin-left:2px;cursor:pointer;pull-right;" href="<?=site_url()?>EventPostage/dispatch_collection" title="Refresh"><img style="width:24px; height:24px" title="Refresh" src="<?=site_url();?>images/refresh.svg"/></a>
			</div>
		</form>
	</div>
</div>
					...
					<tbody>
						<?php foreach($dispatchData as $result) { ?>
							<tr class="row1">
								...
								<?php if($result->ET_RECEIPT_PHONE == "") { ?>
									<td><?php echo $result->ET_RECEIPT_NAME; ?></td>
								<?php } else { ?>
									<td><?php echo $result->ET_RECEIPT_NAME." ("; ?><?php echo $result->ET_RECEIPT_PHONE.")"; ?></td>
								<?php } ?>
...
<form id="formSub" action="<?php echo site_url(); ?>EventGenerationFPDF/" enctype="multipart/form-data" method="post" accept-charset="utf-8">
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer text-left" style="text-align:left;">
					...
					<button style="width: 10%;" type="button" target="_blank" class="btn btn-default sevaButton" id="submit2">Generate</button>
...
<form id="submitForm" action="<?php echo site_url(); ?>EventPostage/save_dispatch_details" class="form-group" role="form" enctype="multipart/form-data" method="post">
...
<script type="text/javascript">	
	...
	function get_datefield_change(date) {
		...
		url = "<?php echo site_url(); ?>EventPostage/get_filter_data";
	...
	function GetSendField() {
		...
		url = "<?php echo site_url(); ?>EventPostage/get_excel_report";
		$("#tddate").attr("action",url)
		$("#tddate").submit();
	}
</script>