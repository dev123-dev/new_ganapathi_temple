	...
	<div class="container">
			<form class="form-group">
				<div class="form-group">
					<span class="eventsFont2">Shashwath Existing Member Receipt</span>
				</div>

				<div class="form-group">
					<a class="pull-right" style="border:none; outline:0;" href="<?=site_url() ?>admin_settings/Admin_setting/existing_import_setting" title="Back"><img style="border:none; outline: 0;margin-top: -77px;" height="35px" width="35px" src="<?php echo base_url(); ?>images/back_icon.svg"></a>
				</div>
				
				<div class="form-group">
					<span style="font-size:18px;"><strong>Name: </strong><?=$deityCounter[0]['RECEIPT_NAME'] ?></span>
					<?php if($deityCounter[0]['RECEIPT_RASHI'] != "") { ?>
						<span style="float:right;clear:both;font-size:18px;margin-top: -27px;"><strong>Rashi: </strong><?=$deityCounter[0]['RECEIPT_RASHI'] ?></span>
					<?php } ?>
				</div>
