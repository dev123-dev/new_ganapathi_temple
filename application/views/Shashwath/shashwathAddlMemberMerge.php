...
<div style="clear:both;" class="container">
	...
	<div class="row form-group">							
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">	
			<span class="eventsFont2">Edit Member Merge Details</span>			
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="table-responsive">
							<table id="eventSeva" class ="table-bordered" >
								...
								<?php $i = 1; ?>
								<?php foreach ($memberMerge as $result) { 
								?> 
								<tr>
			...
			<div class= "col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class= "col-lg-12 col-md-6 col-sm-12 col-xs-9" style="padding-top:25px;">
					<div class="form-group" >
					  ...
					  <input autocomplete="none" type="text" class="form-control form_contct2" id="name" placeholder="" name="name" value="<?php echo str_replace('"','&#34;',$memberMerge[0]->SM_NAME); ?>">
					   	<input type="hidden" id="shashMinId" name="shashMinId" value="<?php echo $memberMerge[0]->SM_ID;?>"/>
					   	<input type="hidden" id="shashMinSsId" name="shashMinSsId" value="<?php echo $memberMerge[0]->SS_ID;?>"/>
					    <input  type="hidden"  id="shashThithiCode" name="shashThithiCode" value="<?php echo $memberMerge[0]->THITHI_CODE;?>"/>
					</div>
				...
				<div class= "col-lg-6 col-md-6 col-sm-12 col-xs-9" style="padding-top:25px;">
					<div class="form-group">
					  ...
					  <input autocomplete="none" type="text" class="form-control form_contct2" id="phone" placeholder="" name="phone" value="<?php echo $memberMerge[0]->SM_PHONE;?>">
					</div>
				</div>
				<div class= "col-lg-6 col-md-6 col-sm-12 col-xs-9" style="padding-top:25px;">
					<div class="form-group">
					  <label for="number">Additional Number</label>
					  <input autocomplete="none" type="text" class="form-control form_contct2" id="phone2" placeholder="" name="phone2" value="<?php echo $memberMerge[0]->SM_PHONE2;?>">
					</div>
				</div>
				<div class= "col-lg-6 col-md-6 col-sm-12 col-xs-9" style="padding-top:25px;">
					<div class="form-group">
					  ...
					  <input autocomplete="none" type="hidden" id="baseurl" name="baseurl" value="<?php echo site_url(); ?>" />
						<div class="dropdown">
							<input autocomplete="off" type="text" class="form-control form_contct2" id="rashi" placeholder="" name="rashi" value="<?php echo $memberMerge[0]->SM_RASHI;?>">
				...
				<div class= "col-lg-6 col-md-6 col-sm-12 col-xs-9" style="padding-top:25px;">
					<div class="form-group">
					  ...
					  <input autocomplete="off" type="hidden" id="baseurl" name="baseurl" value="<?php echo site_url(); ?>" />
						<div class="dropdown">
							<input autocomplete="off" type="text" class="form-control form_contct2" id="nakshatra" placeholder="" name="nakshatra" value="<?php echo $memberMerge[0]->SM_NAKSHATRA;?>">
				...
				<div class= "col-lg-12 col-md-12 col-sm-12 col-xs-9" style="padding-top:20px;">
					<div class="form-group">
					  ...
					  <input autocomplete="off" type="hidden" id="baseurl" name="baseurl" value="<?php echo site_url(); ?>" />
						<div class="dropdown">
							<input autocomplete="off" type="text" class="form-control form_contct2" id="gotra" placeholder="" name="Gotra" value="<?php echo $memberMerge[0]->SM_GOTRA;?>">
			...
			<div class= "col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class= "col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:25px;">
					<div class="form-group">
					  ...
					  <input autocomplete="none" type="text" class="form-control form_contct2" id="addrline1" placeholder="Address Line1" onkeyup="alphaonlyAdrs(this)"  name="name" maxlength="32" value="<?php echo str_replace('"','&#34;',$memberMerge[0]->SM_ADDR1);?>"/>
					</div>
				</div>
				<div class= "col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="form-group">
					  <input autocomplete="none" type="text" class="form-control form_contct2" id="addrline2" placeholder="Address Line2" onkeyup="alphaonlyAdrs(this)"  name="name" maxlength="32" value="<?php echo str_replace('"','&#34;',$memberMerge[0]->SM_ADDR2);?>"/>
					</div>
				</div>
				<div class= "col-lg-12 col-md-4 col-sm-4 col-xs-12">
					<div class="form-group">
					  <input autocomplete="none" type="text" class="form-control form_contct2" id="smcity" placeholder="City" name="name" maxlength="32" value="<?php echo $memberMerge[0]->SM_CITY;?>"/>
					</div>
				</div>
				<div class= "col-lg-4 col-md-4 col-sm-4 col-xs-12">
					<div class="form-group">
					  <input autocomplete="none" type="text" class="form-control form_contct2" id="smstate" placeholder="State" name="name" maxlength="20" value="<?php echo $memberMerge[0]->SM_STATE;?>"/>
					</div>
				</div>
				<div class= "col-lg-4 col-md-4 col-sm-4 col-xs-12">
					<div class="form-group">
					  <input autocomplete="none" type="text" class="form-control form_contct2" id="smcountry" placeholder="Country" name="name" maxlength="20" value="<?php echo $memberMerge[0]->SM_COUNTRY;?>"/>
					</div>
				</div>
				<div class= "col-lg-4 col-md-4 col-sm-4 col-xs-12">
					<div class="form-group">
					  <input autocomplete="none" type="text" class="form-control form_contct2" id="smpin" placeholder="PinCode" name="name" maxlength="6" value="<?php echo $memberMerge[0]->SM_PIN;?>"/></br>
					</div>
				</div>
			</div>
			<div class= "col-lg-6 col-md-6 col-sm-6 col-xs-12" style="padding-left:30px;">
			<label for="comment">Remarks: </label>
				<textarea class="form-control" rows="5" style="resize:none;" id="smremarks"><?php echo $memberMerge[0]->REMARKS;?></textarea>
			</div>
...
<div id="2" class="w5-container city" hidden>
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12 col-md-8 col-sm-8 col-xs-12">
				<div class="form-group">
					<label for="name">Name : <?php echo str_replace('"','&#34;',$memberMerge[0]->SM_NAME); ?></label>
				</div>
			</div>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="table-responsive">
							<table id="eventSeva" class ="table-bordered" >
								...
								?> 
								<tr>
									<td width="2%"><center><?php echo $i; ?></td>
									<td> <center><?php if($result->SS_RECEIPT_NO != "" ) echo $result->RECEIPT_NO . " (".$result->SS_RECEIPT_NO.")"; else echo $result->RECEIPT_NO; ?></td>
									<td> <center><?php echo $result->SS_RECEIPT_DATE;?></td>
									<td><center><?php echo $result->DEITY_NAME; ?></td>
									<td><center><?php echo $result->SEVA_NAME; ?></td>
									<td> <center><?php echo $result->SEVA_QTY; ?></td>
									<td> <center><?php echo $result->RECEIPT_PRICE; ?></td>
									<td><center><?php echo $result->ENG_DATE; ?></td>
									<td><?php echo $result->THITHI_CODE; ?></td> 
									<td><?php echo $result->EVERY_WEEK_MONTH; ?></td> 
									<td><center><?php echo $result->PERIOD_NAME; ?></td>
									<td width="2%"><center><?php echo $result->SEVA_NOTES; ?></td>
									<td style="color:#800000;" title="<?=$result->POSTAL_ADDR; ?>"><center><?php echo (($result->POSTAGE_CHECK == 1)?"YES":"NO"); ?></td>
									<td><center><?php if($result->SS_VERIFICATION == 0) echo "No"; else echo "Yes"; ?></td>
								</tr>
								<?php $i++; } ?>
								</tbody>
							</table>
	...
	<center>
		<input type="button" id="update" value="<?php if(isset($_SESSION['Authorise'])) echo "Verify & Merge Member"; else echo "Update"; ?>" name="Update"  onClick="updateData();" class="btn btn-default btn-lg" />
	</center>
</div>
</div>
</div>
...
<form id="form" action="<?=site_url();?>Receipt/receipt" method="post">
	<input type="hidden" id="smId" name="identity" value="<?php echo $memberMerge[0]->SM_ID;?>"/>
...
$(document).ready(function() { 
	...
	$('#submit').on('click', function () {
		...
		let total = 1;
		let url = "<?=site_url()?>Shashwath/shashwathAddlMemberMergeSave";
		
		$.post(url, {'shashMembId':JSON.stringify(smArray),'shashMinId':shashMinId,'shashThithiCode':shashThithiCode, 'shashMinSsId':shashMinSsId,"name": name,"number": number,"number2": number2,"rashi": rashi,"nakshatra": nakshatra,"gotra": gotra, "addrline1": addrline1,"addrline2": addrline2,"smcity": smcity,"smstate": smstate,
