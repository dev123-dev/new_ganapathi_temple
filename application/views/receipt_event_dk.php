<form id="formSub" action="<?php echo site_url(); ?>Receipt/receipt_dk_save" enctype="multipart/form-data" method="post" accept-charset="utf-8">
	<div class="container py-3 mt-3">
		<img class="img-responsive bgImg2" src="<?=site_url()?>images/TempleLogo.png" />
		<!--Heading And Refresh Button-->
		<div class="row form-group">
			<div class="col-lg-10 col-md-10 col-sm-10 col-xs-8">
				<span class="eventsFont2">Event Donation/Kanike Receipt</span>
			</div>
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
				<a style="width:24px; height:24px" class="pull-right img-responsive" href="<?=site_url()?>Receipt/receipt_donation" title="Reset"><img title="Reset" src="<?=site_url();?>images/refresh.svg"/></a>
			</div>
		</div>
	  ...
	  <div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Event Donation/Kanike Preview</h4>
			</div>
...
<script>
	...
	function field_validation() {
		...
		let toBank = "";	
		// let toBank = $('#tobank option:selected').val();												//laz//laz
		let DCtoBank ="";	
