<form id="formSub" action="<?php echo site_url(); ?>Receipt/receipt_srns_fund_save" enctype="multipart/form-data" method="post" accept-charset="utf-8">
	<div class="container">
		...
		<div class="row form-group">
			<div class="col-lg-10 col-md-10 col-sm-10 col-xs-8">
				<span class="eventsFont2">Shri Rama Navami Samaradhana Fund Receipt</span>
			</div>
			<br/>
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
				<a style="width:24px; height:24px" class="pull-right img-responsive" href="<?=site_url()?>Receipt/receipt_srns_fund" title="Reset"><img title="Reset" src="<?=site_url();?>images/refresh.svg"/></a>
			</div>
		</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 1.5em;">
					<div class="form-inline">
						<label><input style="margin-right: 6px;" id="postage" name="postage" onClick="hidePostageAmt(this);" type="checkbox" value="1">Postage</label>
							...
							<input style="width:50%;visibility:hidden;" value='0' type="text" style="display:hidden;" class="form-control form_contct2" id="postageAmt" placeholder="Amount" name="postageAmt"/>
					</div>
				</div>
	  ...
	  <div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Shri Rama Navami Samaradhana Fund Receipt Preview</h4>
			</div>
