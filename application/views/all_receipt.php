		...
		<form id="dateChange" enctype="multipart/form-data" method="post" accept-charset="utf-8" onsubmit="return field_validation()">
			...
			<div class="col-lg-2 col-md-2 col-sm-3 col-xs-6">
				<div class="input-group input-group-sm form-group">
					<input id="todayDate" name="todayDate" type="text" value="<?php echo $date; ?>" class="form-control todayDate2" placeholder="dd-mm-yyyy" onchange="GetDataOnDate(this.value,'<?php echo site_url()?>Receipt/all_receiptSearch')" readonly="readonly">
			...
			<div class="col-lg-2 col-md-2 col-sm-3 col-xs-6">
				<div class="form-group">
					<select id="receipts_Filter" class="form-control" onchange="GetDataOnFilter(this.value,'<?php echo site_url()?>Receipt/all_receiptSearch')" style="padding: 1px 6px;height:30px;">
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 text-right">
			<?php if(isset($_SESSION['Add'])) { ?>
				...
				<ul class="dropdown-menu addDropDown pull-right" style="margin-right:1em;">
					...
					<li><a href="<?php echo site_url();?>Events/event_receipt">Event Seva</a></li>
					<li><a href="<?php echo site_url();?>Receipt/receipt_donation">Event Donation/Kanike</a></li>
					<li><a href="<?php echo site_url();?>Receipt/receipt_hundi">Event Hundi</a></li>
					<li><a href="<?php echo site_url();?>Receipt/receipt_inkind">Event InKind</a></li>
				</ul>
			<?php } ?>
			<a class="pull-right" href="<?=site_url()?>Receipt/all_receipt" title="Refresh"><img style=" width:24px; height:24px" title="Refresh" src="<?=site_url();?>images/refresh.svg"/></a>&nbsp;&nbsp;
		</div>
	</div>
</div>
				...
				<table class="table table-bordered table-hover">
					...
					<tbody>
						<?php foreach($receipts_details as $result) { ?>
							<tr class="row1">
								<td><a style="text-decoration:none;cursor:pointer;color:#800000;" onClick="printReceipt('<?=$result->ET_RECEIPT_NO; ?>', '<?=$result->ET_RECEIPT_ID; ?>','<?=$result->ET_RECEIPT_CATEGORY_ID;?>')"><?php echo $result->ET_RECEIPT_NO; ?></a></td>
...
<script>
	$('#receiptNo').on('keyup', function(e) {
		if(e.which == 13) {
			url = '<?php echo site_url()?>Receipt/all_receiptSearch';
