<div class="container">
	...
	<div class="row form-group">
		<div class="col-lg-10 col-md-10 col-sm-10 col-xs-8">
			<span class="eventsFont2">Inkind Receipt </span>
		</div>
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
			<a style="width:24px; height:24px" class="pull-right img-responsive" href="<?=site_url()?>Receipt/receipt_inkind" title="Reset"><img title="Reset" src="<?=site_url();?>images/refresh.svg"/></a>
		</div>
	</div>
	...
	<div class="row">
	   <div class="col-md-6 text-left">
		...
		<div class="col-md-6 text-left">
			<div class="sevaDate">	
				<!--Event and Amount-->
				<div class="form-inline col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 1.5em;">
				...
				<div <?php if(@$_SESSION['eventActiveCount'] == 0) echo "style='display:none;'"?> class="form-inline col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 1.5em;">
					<div class="form-group">
						<div class="radio pull-left" style="margin-top: 0.3em;">
						  <label class="radio-inline" style="font-weight: bold;" onclick="GetChangeRadio('event')"><input id="event_Radio" type="radio" value="" name="optradio"> Event</label>
						</div>&nbsp;&nbsp;
  ...
  <div class="modal-dialog modal-lg" role="document">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title">Deity/Event Inkind Preview</h4>
		</div>
	...
	$('#submit2').on('click', function() {
		...
		if(tableItem == "") {
			...
			$.post(url, {'name':$('#name').val(),'panNo':$('#panNo').val(),'adhaarNo':$('#adhaarNo').val(),'email':$('#email').val(),'number':$('#number').val(),'address':$('#address').val(),'paymentNotes':'','event':$('#events').val(), 'deity':$('#deity').val() ,'selRadio':$('#selRadio').val(),'tableItemId':JSON.stringify(tableItemId),'tableItem':JSON.stringify(tableItem),'tableQty':JSON.stringify(tableQty),'tablePrice':JSON.stringify(tablePrice),'tableNotes':JSON.stringify(tableNotes),'postage': postage, 'postageAmt': postageAmt, 'addressLine1': addressLine1, 'addressLine2': addressLine2, 'city': city, 'country': country, 'pincode': pincode,'address':address}, function(e) {
				if(e == "success")
					location.href = "<?=site_url();?>Receipt/receipt_inkindPrint";
				else {
					alert(e);
				}
			});
...
/* 	function checkConfirmTime(date) {
	...
	function field_validation() {
		...
		if(tableItem == "") {
			...
			if (document.getElementById("event_Radio").checked == false)
