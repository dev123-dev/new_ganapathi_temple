...
<div id="addLedgerDiv" style="">
    <div class="container py-5" >
        <form id="frmDeleteLedger" action="<?=site_url()?>finance/discardLedger" method="post">
            <div class="row form-group">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group">
                        <div class="form-inline">
                            ...
                            <input type="number" maxlength="10" name="accountno" id="accountno" class="form-control"  placeholder="" autocomplete="off" style="height: 30px; margin-left: 20px; width:48%" value="<?php echo $ledgerDetails[0]->ACCOUNT_NO;?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-inline">
                            ...
                            <input type="text"  maxlength="10" name="ifsccode" class="form-control" id="ifsccode" placeholder="" autocomplete="off" min="0" style="height: 30px; margin-left: 62px; width:48%" value="<?php echo $ledgerDetails[0]->BANK_IFSC_CODE;?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group" >
                        <div class="form-inline">
                            ...
                            <input type="text" name="bankname" id="bankname" class="form-control" autocomplete="off"  style="height: 30px; margin-left: 52px; width:48%" value="<?php echo $ledgerDetails[0]->BANK_NAME;?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-inline">
                            ...
                            <input type="text" name="branch" id="branch" class="form-control" autocomplete="off"  style="height: 30px; margin-left: 46px; width:48%" value="<?php echo $ledgerDetails[0]->BANK_BRANCH;?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-inline">
                            ...
                            <input type="text" name="location" class="form-control" id="location" placeholder="" autocomplete="off" style="height: 30px; margin-left: 72px;width:48%" value="<?php echo $ledgerDetails[0]->BANK_LOCATION;?>" readonly>
                        </div>
                    </div>
                </div>
