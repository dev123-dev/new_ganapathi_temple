...
<page style="margin-top:25px;margin-left:75%;width:115%;margin-right:75%;">
		<form>
			...
			<center style="padding-bottom:4px;"><span class="eventsFont2" style="display:none;font-size:11px;" id="duplicate"><strong><?="Duplicate";?>&nbsp;</strong></span><span class="eventsFont2" style="font-size:12px;"><strong>Inkind Receipt</strong></span></center>
			<span style="font-size:11px;letter-spacing:1px;"><strong>Receipt Date&nbsp;</strong>: <?=$eventCounter[0]["TET_RECEIPT_DATE"];?></span><br/>
			<span style="font-size:11px;letter-spacing:1px;"><strong>Receipt No.&nbsp;&nbsp;&nbsp;</strong>: <?=$eventCounter[0]['TET_RECEIPT_NO'] ?></span>
			...
			<span style="font-size:11px;letter-spacing:1px;"><strong>Number&nbsp;&nbsp;&thinsp;&thinsp; </strong>: <?=$eventCounter[0]['TET_RECEIPT_PHONE'] ?></span><br/>
			<span style="font-size:11px;letter-spacing:1px;"><strong>Pan No&nbsp;&nbsp;&thinsp;&thinsp; </strong>: <?=$eventCounter[0]['TET_RECEIPT_PAN_NO'] ?></span><br/>
			<span style="font-size:11px;letter-spacing:1px;"><strong>Adhaar No&nbsp;&nbsp; </strong>: <?=$eventCounter[0]['TET_RECEIPT_ADHAAR_NO'] ?></span><br/>
			<span style="font-size:11px;letter-spacing:1px;"><strong>Email&emsp;&ensp;&nbsp;&nbsp;&thinsp; </strong>: <?=$eventCounter[0]['TET_RECEIPT_EMAIL'] ?></span><br/>
			...
			<span style="font-size:11px;float:right;letter-spacing:1px;padding-right:6px;"><strong>Issued By&nbsp;: </strong><?=$eventCounter[0]['TET_RECEIPT_ISSUED_BY'] ?></span>
	...
	<form class="form-group">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-left:0px;padding-right:0px;margin-bottom:2em;" >
			<div class="col-lg-3 col-md-4  col-sm-4 col-xs-12" style="padding-left:0px;">
				<span class="eventsFont2" style="font-size:20px;">Trust Event Inkind Receipt</span>
			</div>
		...
		<div class="form-group">
			...
			<span style="clear:both;float:right;font-size:18px;" class="eventsFont2">Receipt Number: <?=$eventCounter[0]['TET_RECEIPT_NO'] ?></span>
		</div>

		<div class="form-group">
			<span style="font-size:18px;"><strong>Name: </strong><?=$eventCounter[0]['TET_RECEIPT_NAME'] ?></span>
			<?php if(trim($eventCounter[0]['TET_RECEIPT_PHONE']) != "") { ?>
				<span style="float:right;font-size:18px;"><strong>Number: </strong><?=$eventCounter[0]['TET_RECEIPT_PHONE'] ?></span>
			<?php } ?> 
		</div>

		 <div class="form-group">
		 	<?php if(trim($eventCounter[0]['TET_RECEIPT_PAN_NO']) != "") { ?>
				<span style="font-size:18px;"><strong>Pan No: </strong><?=$eventCounter[0]['TET_RECEIPT_PAN_NO'] ?></span>
			<?php } ?> 
			<?php if(trim($eventCounter[0]['TET_RECEIPT_ADHAAR_NO']) != "") { ?>
				<span style="float:right;font-size:18px;"><strong>Adhaar No: </strong><?=$eventCounter[0]['TET_RECEIPT_ADHAAR_NO'] ?></span>
			<?php } ?> 
		</div>

		  
		<div class="form-group">
			<?php if($eventCounter[0]['TET_RECEIPT_EMAIL'] != "") { ?>
				<span style="float: right;font-size:18px;"><strong>Email: </strong><?=$eventCounter[0]['TET_RECEIPT_EMAIL'] ?></span>
			<?php } ?> 
		</div>
		<div style="clear:both"><!--This is required for correct spacing do not remove--></div><br/>
			...
			<div class="form-group">
				...
				<?php if($eventCounter[0]['TET_RECEIPT_PAYMENT_METHOD_NOTES'] != "") { ?>
					<span style="font-size:18px;float:right;"><strong>Notes: </strong><?=$eventCounter[0]['TET_RECEIPT_PAYMENT_METHOD_NOTES']; ?></span>
				<?php } ?>
			</div>
