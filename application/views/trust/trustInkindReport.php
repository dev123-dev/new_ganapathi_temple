<!-- CURRENT EVENT INKIND REPORT -->
 <div class="container">
	<img class="img-responsive bgImg2" src="<?=site_url()?>images/TempleLogo.png">
	<!--Heading And Refresh Button-->
	<div class="row form-group">
		<div class="col-lg-10 col-md-10 col-sm-10 col-xs-8">
			<span class="eventsFont2">Event Inkind Report</span>
	...
	<div class="row">
		...
		<form id="report" enctype="multipart/form-data" method="post" accept-charset="utf-8">
			<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 text-right pull-right">
				...
				<a style="width:24px; height:24px" class="pull-right img-responsive" href="<?=site_url()?>/TrustReport/trust_inkind_report" title="Reset"><img title="reset" src="<?=site_url();?>images/refresh.svg"/></a>
			</div>
...
<script>	
	...
	function GetSendField() {
		...
		url = "<?php echo site_url(); ?>TrustReport/trust_inkind_report_excel";
	...
	function get_datefield_change(date) {
		...
		document.getElementById('tdate').value = date;
		document.getElementById('deityId').value = $('#deity').val();
		url = "<?php echo site_url(); ?>TrustReport/trust_inkind_report_on_change_date";
		$("#tddate").attr("action",url)
		$("#tddate").submit();
	}
	...
	$('#EveryRadio').on('click', function() {
		...
		url = "<?php echo site_url(); ?>TrustReport/trust_inkind_report";
		$("#tddate").attr("action",url)
		$("#tddate").submit();
	});
