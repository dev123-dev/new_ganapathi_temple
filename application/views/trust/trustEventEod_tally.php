					...
					<section class="body">
						<div class="row form-group"> 
							<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 no-pad">
								<h3 style="font-weight:600">Event E.O.D Tally</h3>
							</div>
						</div>
						...
						<!-- <form action="<?php echo site_url(); ?>TrustEventEOD_Tally/" id="chequeNumberSubmit" enctype="multipart/form-data" 	 method="post" accept-charset="utf-8">
...
<!-- admin_settings/Admin_Trust_setting/edit_chequeRemmittance/  -->
  <form id="submitForm" 
  action="<?php echo site_url(); ?>TrustEventEOD_Tally/eodTallySave" 
  id="chequeRemmittanceForm" class="form-group" role="form" enctype="multipart/form-data" method="post">
 <input type="hidden" id="TET_RECEIPT_NO" name="TET_RECEIPT_NO"><br>
 <input type="hidden" id="total1" name="total" value=""><br>
 <input type="hidden" id="bank1" name="bank" value=""><br>
 <input type="hidden" id="EUC_CHEQUE_NO" name="TEUC_CHEQUE_NO"><br>
 <input type="hidden" id="EUC_CHEQUE_DATE" name="TEUC_CHEQUE_DATE"><br>
 <input type="hidden" id="EUC_BANK_NAME" name="TEUC_BANK_NAME"><br>
 <input type="hidden" id="EUC_BRANCH_NAME" name="TEUC_BRANCH_NAME"><br>
 <input type="hidden" id="isDeposited" name="chequedate"><br>
 <input type="hidden" id="updateId" name="TEUC_ID"><br>
 <input type="hidden" id="TEUC_RECEIPT_ID" name="TET_RECEIPT_ID"> <br>  <!--here TEUC_RECEIPT_ID is id of trust_event_receipt primary key -->
  </form>
<script>
// TEUC_RECEIPT_ID
...
let url = "<?=site_url()?>TrustEventEOD_Tally/checkPreviousPendingDate";
$.post(url, {
	date:TEUC_EOD_DATE
},function(e) {
