...
<form action="<?php echo site_url(); ?>Trustfinance/save_finance_voucher_details" enctype="multipart/form-data" method="post" accept-charset="utf-8" onsubmit="return field_validation()">
			...
			<!-- START Row -->
				<div class="row-fluid">
					<div class="span12 widget lime">               
						...
						<?php if($receipt_deity[0]->T_FVC_ABBR2 == "R" || $receipt_deity[0]->T_FVC_ABBR2 == "P" || $receipt_deity[0]->T_FVC_ABBR2 == "J"|| $receipt_deity[0]->T_FVC_ABBR2 == "C" ) { ?>
					...
					<div class="body-inner">    						
						<div class="row form-group">
							<div class="control-group col-md-3 col-lg-3 col-sm-3 col-xs-12">
								...
								<div class="controls">
									<input name="receipt_for" id="receipt_for" type="text" class="span6  form-control register_form" value="<?php echo $receipt_deity[0]->T_FVC_ABBR1; ?>">
							...
							<div class="control-group col-md-3 col-lg-3 col-sm-3 col-xs-12">
								...
								<!--  -->
								<div class="controls">
									<input name="receipt_format" id="receipt_format" type="text" class="span6  form-control register_form" value="<?php echo $receipt_deity[0]->T_FVC_ABBR2; ?>">
									<span class="form-input-info positioning" style="color:#FF0000"></span>
								</div>
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="control-group col-md-6 col-lg-6 col-sm-6 col-xs-12 text-left">
								...
								<button type="button" class="btn btn-default btn-md" onclick="golist('Trustfinance/voucherCounter');"><strong>CANCEL</strong></button>
							</div>
						</div>
					</div>
			   </section>
