...
<form id="frmOpenReceiptPayment" action="<?=site_url()?>Trustfinance/ViewLedger" method="post" >
				...
				<section> 
			        <table class="table" style="border:0px;">
							...
							<?php $total_dr = 0; 
                               ...
                               foreach($sortedData as $result){
                                if($result->T_FLT_DR !=0){
										$total_dr += $result->T_FLT_DR;		
								}
								if($result->T_FLT_CR !=0){
									$totalIncome += $result->T_FLT_CR;
								}
								?>
								
							<?php if(($result->T_RP_TYPE == 'OP' && $T_TYPE_ID == 'A') && $result->T_FLT_DR != 0) {?>
							<tr>
							<td style="color:#800000"><?php echo $result->T_FLT_DATE ?></td>
							<td>Opening Balance :To Balance B/d</td>	 
						   </tr>
							<tr>
								<td></td>	
								<td style="color:#800000"><?php echo $result->T_FGLH_NAME ?></td>
                                <td style="color:#800000"><?php echo $result->T_FLT_DR ?></td>	
							</tr>
							<?php } else if($result->Particular == '' ) { ?>
							<?php } else if($result->T_FLT_DR != 0) {?>
                            <tr>
					...
					<?php   } else if($T_TYPE_ID == 'I') {?> 
							   ...
							   <tr>
								<td></td>
						        <td style="color:#800000;"><?php echo $ledgerName ?></td>	
								<td style="color:#800000;"><?php echo $totalIncome ?></td>
							</tr>
					...
					<section> 
						<table class="table" style="border:0px;">
							...
							<?php $total_cr = 0; 
							    ...
							    foreach($sortedData  as $result){
                                if($result->T_FLT_CR !=0){
									$total_cr+=$result->T_FLT_CR;
								}
								if($result->T_FLT_DR !=0){
									$totalExpense += $result->T_FLT_DR;
								}
								?>
									<?php if((($result->T_RP_TYPE == 'OP' ) && $T_TYPE_ID == 'L') && $result->T_FLT_CR != 0) {?>
										<tr>
										<td style="color:#800000"><?php echo $result->T_FLT_DATE ?></td>	
							               ...
							               <tr>
								            <td></td>
								             <td style="color:#800000"><?php echo $result->T_FGLH_NAME ?></td>
                                             <td style="color:#800000"><?php echo $result->T_FLT_CR ?></td>	
							               </tr>
										  
									<?php } else if($result->Particular == '') {?>
									
									<?php } else if($result->T_FLT_CR != 0){?>
                                  <tr>
								     <td><?php echo $result->T_FLT_DATE ?></td>	
								     <td><?php echo $result->Particular ?></td>
					...
					<section> 
						<table class="table"  >
							<tr style='border-top:2px solid#800000;padding:50px;'>
								...
								<th width="20%">
									<?php if($T_TYPE_ID == 'I') { echo $totalIncome;?>
