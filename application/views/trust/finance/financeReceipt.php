...
<div class="container-fluid container">
    <div class="row form-group">
      ...
      <div class="col-lg-3 col-md-10 col-sm-10 col-xs-8" style="padding-left: -20px;">
        <form id="frmCommitteeChange" action="<?=site_url()?>Trustfinance/Receipt" method="post">
      ...
      <div class="col-lg-2 col-md-2 col-sm-2 col-xs-4" style = "padding-top:10px;">
        <a style="text-decoration:none;cursor:pointer;pull-right;" href="<?=site_url()?>Trustfinance/Receipt" title="Refresh"><img style="width:24px; height:24px" title="Refresh" src="<?=site_url();?>images/refresh.svg"/></a>
      </div>
    </div>
            ...
            <select id="aidR"  class="form-control" name="aidR" style="height: 30px;width:100%" onChange="AccountChange();">
              ...
              <?php   if(!empty($account)) {
                foreach($account as $row1) { ?> 
                  <option value="<?php echo $row1->T_FGLH_ID;?>|<?php echo $row1->BALANCE;?>|<?php echo $row1->T_FGLH_NAME;?>|<?php echo $row1->T_FGLH_PARENT_ID;?>"><?php echo $row1->T_FGLH_NAME;?>  
                </option>
              <?php } } ?>
            </select> 
...
<script type="text/javascript">
    ...
    function validateReceipt() {
      ...
      let url = "<?=site_url()?>Trustfinance/addReceiptTrans";
