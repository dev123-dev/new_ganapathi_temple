...
<div class="col-lg-12 col-md-12 col-sm-8 col-xs-8 pull-right text-right" style = "padding-right:0px;padding-bottom:10px;padding-top:10px; margin-top:-4em">
	...
	<a style="text-decoration:none;cursor:pointer;pull-right; margin-left: 5px;" href="<?=site_url()?>Trustfinance/addCommittee" title="Refresh"><img style="width:24px; height:24px" title="Refresh" src="<?=site_url();?>images/refresh.svg"/></a>
</div>
			...
			<table class="table table-bordered table-hover">
				...
				<tbody>
					<?php foreach($AllCommittee as $result) { ?>
						<tr>
							<td><center><?php echo $result->T_COMP_ID; ?></center></td>
							<td><center><?php echo $result->T_COMP_NAME; ?></center></td>
							<td class="text-center" width="10%"><a style="border:none; outline: 0;" href="#" title="Edit Committee Name" ><img style="border:none; outline: 0;" onclick = "editCommitteeName(<?php echo $result->T_COMP_ID.",'".$result->T_COMP_NAME."'";?>)" src="<?php echo	base_url(); ?>images/edit_icon.svg"></a></td>
						</tr>
					<?php } ?>
				</tbody>
			</table>
...
<form id="frmAddCommitteeDetails" action="<?=site_url()?>Trustfinance/addCommitteeDetails" method="post">
	<!-- Modal -->
...
<form id="editformCommittee" action="<?=site_url()?>Trustfinance/updateCommitteeName" method="post">
	<!-- Modal -->
