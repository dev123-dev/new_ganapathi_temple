...
<div id="addLedgerDiv" style="">
    <div class="container py-5" >
        <form id="frmEditLedger" action="<?=site_url()?>Trustfinance/updateLedger" method="post">
        <div class="row form-group">
        ...
        <div class="row form-group">
            ...
            <div class="control-group col-md-4 col-lg-2 col-sm-4 col-xs-6" style="margin-left: -1.6em;">
                ...
                <?php } ?>
                <input type="hidden" name="fdyesId" id="fdyesId" value="<?php echo $ledgerDetails[0]->T_IS_FD_STATUS;?>">
            </div>
        </div>
     ...
     <select id="Bank" name="Bank" class="form-control" style="height: 30px; width: 200px; margin-left:18%">
               ...
               <?php if(!empty($bank)) { 
                   ...
                   foreach($bank as $row1) { 
                       if($ledgerDetails[0]->FD_BANK_ID == $row1->T_FGLH_ID){ 
                           $FD_BANK_NAME = $row1->T_FGLH_NAME; ?> 
                          <option value="<?php echo $row1->T_FGLH_ID;?>|<?php echo $row1->T_FGLH_NAME;?>" selected><?php echo $FD_BANK_NAME; ?></option>
                   <?php } else { ?> 
                   <option value="<?php echo $row1->T_FGLH_ID;?>|<?php echo $row1->T_FGLH_NAME;?>"><?php echo $row1->T_FGLH_NAME;?></option>                                <?php } } } ?>
  ...
  <div class="row form-group" id="fddive" style="display: none;">
            ...
            <div class="control-group col-md-2 col-lg-2 col-sm-4 col-xs-6">               
             ...
             <div class="col-lg-2 col-md-2 col-sm-12 col-xs-6" id="opDate">              
                ...
                <input autocomplete="" name= "todayDate3" id="todayDate3" type="text" value="<?php echo $ledgerDetails[0]->T_FD_MATURITY_START_DATE;?>" class="form-control fdstartDate" onchange="GetDataOnDate(this.value)" placeholder="dd-mm-yyyy" readonly = "readonly" />
           ...
           <div class="row form-group" id="fddiv" style="display: none;">
            ...
            <div class="control-group col-md-2 col-lg-2 col-sm-4 col-xs-6">               
             ...
             <div class="col-lg-2 col-md-2 col-sm-12 col-xs-6" id="opDate">              
                ...
                <input type="hidden" name="date" value="<?=@$date; ?>" id="date" value="" >
                <input type="hidden" name="load" id="load" value="">
                <input autocomplete="" name= "todayDate1" id="todayDate1" type="text" value="<?php echo $ledgerDetails[0]->T_FD_MATURITY_END_DATE;?>" class="form-control fdendDate" onchange="GetDataOnDate(this.value)" placeholder="dd-mm-yyyy" readonly = "readonly" />
                <div class="input-group-btn">
          ...
          <div class="row form-group" id="fdinterestrate" style="display: none;">
           ...
           <div class="control-group col-md-4 col-lg-2 col-sm-4 col-xs-6"> 
             <input autocomplete="off" type="hidden" id="baseurl" name="baseurl" value="<?php echo site_url(); ?>" /> 
                    ...
                    <input autocomplete="off" style="height:30px; "  class="form-control"  type="text" name="intrestrate" placeholder="Intrest Rate" id="intrestrate" value="<?php echo $ledgerDetails[0]->T_FD_INTEREST_RATE;?>">
        ...
        <!-- abhipra ends-->
                ...
                <table id="addCommittee" class="table table-bordered table-hover">
                            ...
                            <tr class=" <?php echo $si; ?> si1">
                                ...
                                <?php if(@$_SESSION['userGroup'] == "1" || @$_SESSION['userGroup'] == "6" || @$_SESSION['userGroup'] == "2" ){ ?>
                                    <td ><input class="form-control"  type="text" name="Balance" id="Balance_<?php echo $result->T_COMP_ID; ?>" autocomplete="off" value="<?php echo $result->BALANCE ?>"></td>
                                <?php } else { ?>
                                     <td class=""><?php echo $result->BALANCE; ?></td>
                                <?php } ?>
                                <td class="committeeId committeeIdCheck" id="<?php echo $result->T_COMP_ID; ?>" style="display: none;"><?php echo $result->T_COMP_ID; ?></td>
                                <td class="text-center"> 
                                    <?php if(@$_SESSION['userGroup'] == "1" || @$_SESSION['userGroup'] == "6" || @$_SESSION['userGroup'] == "2" ){ ?>               
                                    <a style="border:none; outline: 0;" href="#" title="Edit Opening Balance" ><img style="border:none; outline: 0;" width="24px" height="24px" onclick = "editOpeningBalance(<?php echo $result->T_FLT_ID.",".$result->BALANCE.",".$result->T_COMP_ID; ?>)" src="<?php echo base_url(); ?>images/check_icon.svg"></a>
                                    <?php } ?>
                                </td>
                            </tr>
                            <?php $si++;
            ...
            <div class="row form-group" id="opBalDiv" style="display: none">
                ...
                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-6">
                <?php if(($ledgerDetails[0]->T_TYPE_ID == 'A' || $ledgerDetails[0]->T_TYPE_ID == 'L')) {
                    if( count($assignedComp) != 0) {?> 
                   ...
                   <?php }else{?>
                    <!-- <input style="height: 31px;width: 200px; " type="text" class="opening form-control" name="opAmt" id="opAmt" placeholder="Opening Balance Amount" autocomplete="off" min="0" value=""> -->
                 ...
                 <div class="col-lg-2 col-md-2 col-sm-12 col-xs-6">
                   <?php if((@$_SESSION['userGroup'] == "1" || @$_SESSION['userGroup'] == "6" || @$_SESSION['userGroup'] == "2")&& ($ledgerDetails[0]->T_TYPE_ID == 'A' || $ledgerDetails[0]->T_TYPE_ID == 'L') ){ 
                    if(count($assignedComp) != 0) {?>               
                    <a style="margin-left: 12px;" href="#" title="Edit Opening Balance" ><img style="border:none; outline: 0;" width="24px" height="24px" onclick = "editOpeningBalance(<?php echo $assignedComp[0]->T_FLT_ID.",".$assignedComp[0]->BALANCE.",".$assignedComp[0]->T_COMP_ID;; ?>)" src="<?php echo base_url(); ?>images/check_icon.svg"></a>
                    <?php }else{?>
                        <!-- <a style="margin-left: 12px;" href="#" title="Edit Opening Balance" ><img style="border:none; outline: 0;" width="24px" height="24px" onclick = " addRow1()" src="<?php echo base_url(); ?>images/check_icon.svg"></a> -->
                    <?php } 
                    } ?>
                </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group">
                        <div class="form-inline">
                            ...
                            <input type="text" maxlength="20" name="accountno" id="accountno" class="form-control"  placeholder="" autocomplete="off" onkeyup="alphaonlynumber(this)" style="height: 30px; margin-left: 20px; width:48%" value="<?php echo $ledgerDetails[0]->T_ACCOUNT_NO;?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-inline">
                            ...
                            <input type="text"  maxlength="11" name="ifsccode" class="form-control ifsc" id="ifsccode" placeholder="" autocomplete="off" min="0" style="height: 30px; margin-left: 62px; width:48%" value="<?php echo $ledgerDetails[0]->T_BANK_IFSC_CODE;?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group" >
                        <div class="form-inline">
                            ...
                            <input type="text" name="bankname" id="bankname" class="form-control" onkeyup="alphaonly(this)" autocomplete="off"  style="height: 30px; margin-left: 52px; width:48%" value="<?php echo $ledgerDetails[0]->T_BANK_NAME;?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-inline">
                            ...
                            <input type="text" name="branch" id="branch" class="form-control" onkeyup="alphaonly(this)" autocomplete="off"  style="height: 30px; margin-left: 46px; width:48%" value="<?php echo $ledgerDetails[0]->T_BANK_BRANCH;?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-inline">
                            ...
                            <input type="text" name="location" class="form-control" id="location" placeholder="" autocomplete="off" style="height: 30px; margin-left: 72px;width:48%" value="<?php echo $ledgerDetails[0]->T_BANK_LOCATION;?>">
                        </div>
                    </div>
                </div>
                        ...
                        <table id="addledger" class="table table-bordered table-hover">
                          ...
                          <tbody id="eventUpdate">
                            ...
                            <tr>
                                ...
                                <?php if($result->AMT==0 ) { ?>
                                    <td><center><a style="cursor:pointer;" id="removeBtn_<?php echo $result->T_BLA_ID; ?>" onClick="removeExisting('<?php echo $result->T_BLA_ID; ?>')"><img style="width:24px; height:24px;" title="delete" src="<?=base_url()?>images/delete1.svg"></a></center></td>
                                <?php }else{ ?> <td></td> <?php } ?>
                            </tr>
                    <?php } ?>
                        </tbody>
...
<script type="text/javascript">
    ...
    function addRow1() {
        let bankdetail = '<?php echo $parentDetails[0]->T_TYPE_ID ?>';
       var count = 0;
  ...
  $( ".fdendDate" ).datepicker({ 
    ...
    function editOpeningBalance(fltId,oldBalance,compId){
        console.log(fltId,oldBalance,compId)
       let Balance="";
        if(document.getElementById("underId").value != '9'){
    ...
    function editOpeningBalanceAmount(fltId,oldBalance,compId){
        ...
        let url = "<?=site_url()?>Trustfinance/updateOpeningBalance";
