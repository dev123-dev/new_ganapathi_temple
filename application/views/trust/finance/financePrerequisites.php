<div class="container-fluid container">
	<form id="frmprerequisites" action="<?=site_url()?>Trustfinance/save_finance_prerequisites" method="post" enctype="multipart/form-data"
					...
					<div class="row-fluid">
									...
									<div class="row">
										...
										<div class="col-md-2 col-lg-2 col-sm-2 col-xs-12 ">
											...
											<div class="input-group input-group-sm">
												...
												<input autocomplete="" name= "todayDate" id="todayDate" type="text" value="<?php echo $fyear->T_FP_FIN_BEGIN_DATE;  ?>" class="form-control todayDate2"  onchange="GetDataOnDate(this.value)" placeholder="dd-mm-yyyy" readonly = "readonly" />
									...
									<div class="row">
										...
										<div class="col-md-2 col-lg-2 col-sm-2 col-xs-12 ">
											<div class="input-group input-group-sm">
												...
												<input autocomplete="" name= "toDate" id="toDate" type="text" value="<?php echo $fyear->T_FP_BOOKS_BEGIN_DATE;?>" class="form-control todayDate3"  onchange="GetDataOnDate1(this.value)" placeholder="dd-mm-yyyy" readonly = "readonly" />
												<div class="input-group-btn">
						...
						<div class="row form-group">
							<div class="control-group col-md-6 col-lg-6 col-sm-6 col-xs-12 text-left">
              					<input type="button" class="btn btn-default btn-md custom" value="Submit" onclick="validateFinancePrerequisites()">
...
<script>
	function validateFinancePrerequisites() {
		...
		let url = "<?=site_url()?>Trustfinance/save_finance_prerequisites";
		if( todayDate == "" || toDate == "") {
