							...
							<table class="table table-bordered table-hover">
								...
								<tbody>
									<?php foreach($finance_voucher_counter as $result) { ?>
										<tr class="row1">
											<td><?php echo $result->T_FVC_NAME; ?></td>
											<td><?php echo $result->T_FVC_ABBR1." / ".$result->T_FVC_ABBR2; ?></td>
											<td><?php echo $result->T_FVC_COUNTER; ?></td>
											<td>
												<center>
													<a style="border:none; outline: 0;" title="Reset Finance Voucher Counter"><img onclick="GetResetCounter('<?php echo $result->T_FVC_NAME; ?> Voucher','<?php echo site_url(); ?>Trustfinance/update_finance_voucher_counter/','<?php echo $result->T_FVC_ID; ?>')" style=" width:24px; height:24px;border:none; outline: 0;" src="<?php echo base_url(); ?>images/Change_pswd.svg"></a>
													<a style="border:none; outline: 0;" href="<?php echo site_url(); ?>Trustfinance/edit_finance_voucher_details/<?php echo $result->T_FVC_ID; ?>" title="Edit Receipt Details" ><img style="border:none; outline: 0;" src="<?php echo	base_url(); ?>images/edit_icon.svg"></a>
