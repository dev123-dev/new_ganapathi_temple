	...
	<div class="row form-group">
		<form id="tddate" enctype="multipart/form-data" method="post" accept-charset="utf-8">
			...
			<div class="col-offset-lg-5 col-lg-2 col-md-3 col-sm-12 col-xs-12 pull-right text-right">
				...
				<?php } ?>
				<a style="margin-left:2px;cursor:pointer;pull-right;" href="<?=site_url()?>TrustEventPostage/dispatch_collection" title="Refresh"><img style="width:24px; height:24px" title="Refresh" src="<?=site_url();?>images/refresh.svg"/></a>
			</div>
		</form>
	</div>
</div>
...
<form id="formSub" action="<?php echo site_url(); ?>TrustEventGenerationFPDF/" enctype="multipart/form-data" method="post" accept-charset="utf-8">
...
<form id="submitForm" action="<?php echo site_url(); ?>TrustEventPostage/save_dispatch_details" class="form-group" role="form" enctype="multipart/form-data" method="post">
...
<script type="text/javascript">	
	...
	function get_datefield_change(date) {
		...
		url = "<?php echo site_url(); ?>TrustEventPostage/get_filter_data";
	...
	function GetSendField() {
		...
		url = "<?php echo site_url(); ?>TrustEventPostage/get_excel_report";
		$("#tddate").attr("action",url)
		$("#tddate").submit();
	}
</script>