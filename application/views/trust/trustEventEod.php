...
<div class="container">
	...
	<div class="row form-group">
		...
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
			<a style="width:24px; height:24px" class="pull-right img-responsive" href="<?=site_url()?>TrustEventEOD" title="Refresh"><img title="Refresh" src="<?=site_url();?>images/refresh.svg"/></a>
		</div>
	</div>
</div>
					...
					<tbody>
						<?php foreach($eod_receipt_report as $result) { ?>
							<tr class="row1">
								...
								<td><?php if($_SESSION['userId'] != "1" && $_SESSION['userId'] != "2" && $_SESSION['userId'] != "6") { ?><center><button onClick='eodOnDate("<?php echo $result->TET_RECEIPT_DATE; ?>")' type="button" class="btn btn-default btn-sm">View</Button></center><?php } ?></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>
