<form id="formSub" action="<?php echo site_url(); ?>Auction/auction_item_details" enctype="multipart/form-data" method="post" accept-charset="utf-8">
	<div class="container py-3 mt-3">
		...
		<div class="row form-group">
			...
			<div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
				<a style="width:24px; height:24px" class="pull-right img-responsive" href="<?=site_url()?>Auction/add_auction_item_list" title="Reset"><img src="<?=site_url();?>images/refresh.svg"/></a>
			</div>
		</div>
			...
			<div class="col-md-6 text-left">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 1.5em;">
					<div class="form-inline">
					  ...
					  <textarea class="form-control" rows="5" id="address" name="address" placeholder="Near Classic Chaya, Santhakatte" style="width: 100%;resize:none;"><?=@$address;?></textarea>
					</div>
				</div>
			</div>
			...
			<div class="col-md-6 text-left">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="margin-bottom: 1em;">
					<div class="form-group">
					  ...
					  <textarea class="form-control" rows="2" id="sareeDetails" name="sareeDetails" style="resize:none;"><?=@$itemDetails;?></textarea>
					</div>
				</div>
	...
	<!-- HIDDEN FIELDS -->
	<input type="hidden" id="eventId" name="eventId" value="<?=$event['ET_ID']; ?>">
	<input type="hidden" id="eventName" name="eventName" value="<?=$event['ET_NAME']; ?>">
...
<script>
	...
	function field_validation() {	
		...
		if(res == "") {
			...
			let url = "<?=site_url()?>Auction/checkHarivanaExist"
