<div class="container">
	<form class="form-group" method="post" action="<?php echo site_url(); ?>Auction/issue_auction_receipt_save">
		<div class="col-lg-12">
			<div class="form-group">
				<center><label class="eventsFont2 samFont1"><?=$event['ET_NAME']; ?></label></center>
				<input type="hidden" name="eventName" id="eventName" value="<?=$event['ET_NAME']; ?>"/>
				<input type="hidden" name="eventId" id="eventId" value="<?=$event['ET_ID']; ?>"/>
