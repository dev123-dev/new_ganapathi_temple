    ...
    <div class="row form-group">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="col-lg-2 col-md-2 col-sm-1 col-xs-2">
                <a style="width:24px; height:24px" class="pull-right img-responsive" href="<?=site_url()?>Auction/bid_auction_item" title="Reset"><img title="Reset" src="<?=site_url();?>images/refresh.svg"/></a>
            </div>
        </div>
    </div> 
	<form method="post" action="<?=site_url()?>Auction/bid_auction_preview" id="form">
		<div class="row form-group">
			<div class="col-md-6 text-left">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="itemDetails" style="display:none;">
					<div class="form-group">
						...
						<textarea class="form-control" rows="5" id="itemDet" name="itemDet" placeholder="" style="width: 100%;resize:none;" readonly>
						</textarea>
					</div>
				</div>
			...
			<div class="col-md-6 text-left">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 1.5em;">
					<div class="form-group">
						...
						<textarea class="form-control" rows="5" id="address" name="address" placeholder="" style="width: 100%;resize:none;"></textarea>
					</div>
				</div>
...
<script>
	...
	function itemRefComboChange(id) {
		...
		if(id != "") {
			var res = id.split("|");
			let url = "<?php echo site_url(); ?>Auction/get_saree_details";
    ...
    function field_validation() {
		var url = "<?=site_url()?>Auction/saveBid";
		var name = $('#name').val();
		var phone = $('#phone').val();
		var email = $('#email').val();
		...
		if(res != "") {
			$('.modal-body').html("");
			$('.modal-body').append("<div class='col-lg-4 col-md-4 col-sm-4 col-xs-12'><label>Event: "+ "<?=$event['ET_NAME']; ?>" +"</label></div>");
