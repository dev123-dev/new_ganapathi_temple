<div class="container">
	...
	<div class="row form-group">
		...
		<form enctype="multipart/form-data" method="post" accept-charset="utf-8" action="<?=site_url();?>Auction/SearchAuctionReceipt">
		...
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 text-right">
			<a style="width:24px; height:24px" class="pull-right img-responsive" href="<?=site_url()?>Auction/issue_auction" title="Refresh"><img title="Refresh" src="<?=site_url();?>images/refresh.svg"/></a>
		</div>
	</div>
</div>
<div class="container">
					...
					<tbody>
						<?php foreach($bid_item_list as $result) { ?>
							<tr>
								...
								?>
								<?php if($i == 1) { ?>
									<td><a style="color:#800000;" href="<?php echo site_url(); ?>Auction/issue_receipt_print/<?php echo $receiptId; ?>"><?php echo $receiptNo; ?></a></td>
								<?php } else { ?>
									<td><a style="color:#800000;" href="<?php echo site_url(); ?>Auction/issue_auction_receipt/<?php echo $result->BIL_ID; ?>"><?php echo "Issue Receipt" ?></a></td>
								<?php } ?>
							</tr>
						<?php } ?>
					</tbody>
...
<script>
	...
	function show_bid(name,number,email,address){
        var c_url ="<?php echo site_url(); ?>Auction/View";
        $.ajax({
			url: c_url,
