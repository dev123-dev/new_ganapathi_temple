...
<div class="container">
	<form class="form-group" action="<?=site_url()?>Auction/add_auction_item">
		<div class="form-group">
		<center><label class="eventsFont2 samFont1"><?=$event['ET_NAME']; ?></label></center>
			...
			<?php } else { ?>
				<a class="pull-right" style="border:none; outline:0;" href="<?=site_url() ?>Auction/add_auction_item_list" title="Back"><img style="border:none; outline: 0;margin-top: -71px;" src="<?php echo base_url(); ?>images/back_icon.svg"></a>
			<?php } ?>
		</div>
