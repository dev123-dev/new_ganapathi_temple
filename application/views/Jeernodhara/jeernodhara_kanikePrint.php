...
<!--for printing --><div id="printScreen" style="display:none">
	<page style="margin-top:25px;margin-left:75%;width:115%;margin-right:75%;">
		<form>
			...
			<center style="margin-top:50px;"><span class="eventsFont2" style="display:none;font-size:11px;padding-bottom:4px;" id="duplicate"><strong><?="Duplicate";?>&nbsp;</strong></span><span class="eventsFont2" style="font-size:11px;margin-top:35px;padding-bottom:4px;"><strong>Kanike Receipt</strong></span></center>
...
<div class="container">
	<form class="form-group">
		<div class="row form-group">
			<div class="col-lg-6 eventsFont2" style="font-size:25px;">Jeernodhara Kanike Print</div>
	...
	<form id="submitForm" action="<?php echo site_url(); ?>Receipt/save_cancel_note_jeernodhara_kanike/" class="form-group" role="form" enctype="multipart/form-data" method="post">
