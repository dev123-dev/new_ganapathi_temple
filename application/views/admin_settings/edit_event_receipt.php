<form action="<?php echo site_url(); ?>admin_settings/Admin_setting/save_event_receipt_details" enctype="multipart/form-data" method="post" accept-charset="utf-8" onsubmit="return field_validation()">
			...
			<!-- START Row -->
				<div class="row-fluid">
					<div class="span12 widget lime">               
						...
						<?php if($receipt_event[0]->ET_ABBR2 == "IK") { ?>
							<h6 class="registr"><i>(Inkind)</i></h6>
						<?php } else { ?>
							<h6 class="registr"><i>(<?php echo $receipt_event[0]->ET_NAME." - Seva, Donation/Kanike, Hundi"; ?>)</i></h6>
						<?php } ?>
					</div>           
				</div>	
				<br/>
					...
					<div class="body-inner">    						
						<div class="row form-group">
							<div class="control-group col-md-3 col-lg-3 col-sm-3 col-xs-12">
								...
								<div class="controls">
									<input name="et_receipt_for" id="et_receipt_for" type="text" class="span6  form-control register_form" value="<?php echo $receipt_event[0]->ET_ABBR1; ?>">
							...
							<div class="control-group col-md-3 col-lg-3 col-sm-3 col-xs-12">
								...
								<?php } ?>
								<div class="controls">
									<input name="et_receipt_format" id="et_receipt_format" type="text" class="span6  form-control register_form" value="<?php echo $receipt_event[0]->ET_ABBR2; ?>">
									<span class="form-input-info positioning" style="color:#FF0000"></span>
								</div>
							</div>
						</div>
