<form action="<?php echo site_url(); ?>admin_settings/Admin_Trust_setting/save_block_date" enctype="multipart/form-data" method="post" accept-charset="utf-8" onsubmit="return field_validation()">
			...
			<!-- START Row -->
				<div class="row-fluid">
					<div class="span12 widget lime">               
						<h3 class="registr"><span class="icon icone-crop"></span>Add Block Date</h3> 
					</div>           
				</div>	
				<br/>
				<section class="body">
