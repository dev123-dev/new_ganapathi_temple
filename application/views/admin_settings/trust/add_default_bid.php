<form action="<?php echo site_url(); ?>admin_settings/Admin_Trust_setting/save_default_bid" enctype="multipart/form-data" method="post" accept-charset="utf-8" onsubmit="return field_validation()">
