<form action="<?php echo site_url(); ?>admin_settings/Admin_Trust_setting/save_bid_range" enctype="multipart/form-data" method="post" accept-charset="utf-8" onsubmit="return field_validation()">
			...
			<!-- START Row -->
				<div class="row-fluid">
					<div class="span12 widget lime">               
						<h3 class="registr"><span class="icon icone-crop"></span>Add Bid Range</h3>                 
					</div>           
				</div>	
				<br/>
				<section class="body">
					<div class="body-inner">    
						<div class="row form-group">							
							...
							<div class="control-group col-md-2 col-lg-2 col-sm-2 col-xs-12">
								...
								<div class="controls">
									<input name="bid_value_from" id="bid_value_from" type="text" class="span6  form-control register_form" value="">
									<span class="form-input-info positioning" style="color:#FF0000"></span>
								</div>
							</div> 
							...
							<div class="control-group col-md-2 col-lg-2 col-sm-2 col-xs-12">
								...
								<div class="controls">
									<input name="bid_value_to" id="bid_value_to" type="text" class="span6  form-control register_form" value="">
									<span class="form-input-info positioning" style="color:#FF0000"></span>
								</div>
							</div> 
