<form action="<?php echo site_url(); ?>admin_settings/Admin_Trust_setting/save_inkind" enctype="multipart/form-data" method="post" accept-charset="utf-8" onsubmit="return field_validation()">
			...
			<!-- START Row -->
				<div class="row-fluid">
					<div class="span12 widget lime">               
						<h3 class="registr"><span class="icon icone-crop"></span>Add Inkind Item</h3>                 
					</div>           
				</div>	
				<br/>
				<section class="body">
					<div class="body-inner">    
						<div class="row form-group">							
							...
							<div class="control-group col-md-1 col-lg-1 col-sm-1 col-xs-12">
								...
								<div class="controls">
									<input name="unit_name" id="unit_name" type="text" onkeypress="CheckForLetterOnly(event,this)" class="span6  form-control register_form" value="">
									<span class="form-input-info positioning" style="color:#FF0000"></span>
								</div>
							</div> 
						</div>
						...
						<div class="row form-group">
							<div class="control-group col-md-6 col-lg-6 col-sm-6 col-xs-12 text-left">
								...
								<button type="button" class="btn btn-default btn-md" onclick="golist('admin_settings/Admin_Trust_setting/inkind_items');"><strong>CANCEL</strong></button>
							</div>
						</div>
					</div>
			   </section>
