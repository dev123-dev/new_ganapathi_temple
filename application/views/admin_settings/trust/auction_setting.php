				...
				<div class="span12 widget lime">
					<div class="row form-group"> 
						...
						<div class="col-md-10 col-lg-10 col-sm-10 col-xs-4 text-right">
							<a style="border:none; outline:0;" href="<?php echo site_url(); ?>admin_settings/Admin_Trust_setting/add_auction_item" title="Add "><img style="border:none; outline: 0;margin-top:1.4em;margin-bottom:.5em;" src="<?php echo base_url(); ?>images/add_icon.svg"></a>
						</div>
					</div>
					<section class="body">
						...
						<div class="row form-group"> 
							...
							<div class="col-md-10 col-lg-10 col-sm-10 col-xs-4 text-right">
								<a style="border:none; outline:0;" href="<?php echo site_url(); ?>admin_settings/Admin_Trust_setting/add_default_bid" title="Add "><img style="border:none; outline: 0;margin-top:1.4em;margin-bottom:.5em;" src="<?php echo base_url(); ?>images/add_icon.svg"></a>
							</div>
						</div>
								...
								<tbody>
									<?php foreach($default_bid as $result) { ?>
										<tr class="row1">
											...
											<td><center><a style="border:none; outline: 0;" href="<?php echo site_url(); ?>admin_settings/Admin_Trust_setting/edit_default_bid/<?php echo $result->IDB_ID; ?>" title="Edit Bid Value"><img style="border:none; outline: 0;" src="<?php echo	base_url(); ?>images/edit_icon.svg"></a></center></td>
										</tr>
									<?php } ?>
								</tbody>
							</table>
						...
						<div class="row form-group"> 
							...
							<div class="col-md-10 col-lg-10 col-sm-10 col-xs-4 text-right">
								<a style="border:none; outline:0;" href="<?php echo site_url(); ?>admin_settings/Admin_Trust_setting/add_bid_range" title="Add "><img style="border:none; outline: 0;margin-top:1.4em;margin-bottom:.5em;" src="<?php echo base_url(); ?>images/add_icon.svg"></a>
							</div>
						</div>
								...
								<tbody>
									<?php foreach($bid_range as $result) { ?>
										<tr class="row1">
											...
											<td><center><a style="border:none; outline: 0;" href="<?php echo site_url(); ?>admin_settings/Admin_Trust_setting/edit_bid_range/<?php echo $result->IBR_ID; ?>" title="Edit Bid Value"><img style="border:none; outline: 0;" src="<?php echo	base_url(); ?>images/edit_icon.svg"></a></center></td>
										</tr>
									<?php } ?>
								</tbody>
							</table>
...
<script>
	...
	function GetStatusChange(status,itemName,id) {
		if(status == 1) {
			alertTrustAuction("Warning","Are you sure, you want to <strong>deactivate</strong> the <strong>"+ itemName +"</strong>?","Deactivate",true,id,0);
		} else {
			alertTrustAuction("Warning","Are you sure, you want to <strong>activate</strong> the <strong>"+ itemName +"</strong>?","Activate",true,id,1);
		}
	}
</script>