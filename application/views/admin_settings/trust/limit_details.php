					...
					<form id="formLimit" enctype="multipart/form-data" method="post" accept-charset="utf-8">
						<div class="row form-group"> 
							<div class="control-group col-md-3 col-lg-3 col-sm-3 col-xs-10" style="margin-bottom:1em;">
								...
								<div class="controls">
									<input name="seva_name" id="seva_name" type="text" class="span6  form-control register_form" readonly value="<?php echo $admin_settings_event_seva[0]->TET_SEVA_NAME; ?>">
									<span class="form-input-info positioning" style="color:#FF0000"></span>
									<!-- HIDDEN FIELD -->
									<input name="seva_id" id="seva_id" type="hidden" value="<?php echo $admin_settings_event_seva[0]->IS_SEVA ."¶". $admin_settings_event_seva[0]->TET_SEVA_ID; ?>">
								</div>
							</div>
							<?php   ?>
							<?php if($admin_settings_event_seva[0]->IS_SEVA != 0) { ?>
								...
								<div class="control-group col-md-3 col-lg-3 col-sm-3 col-xs-2">
									<div class="controls">
										...
										<a style="border:none; outline:0;cursor:pointer;" onclick="return GetValidationAndLimit('<?php echo site_url(); ?>admin_settings/Admin_Trust_setting/get_add_limit_stock/1')" title="Add Limit"><img style="border:none; outline: 0;margin-top:.8em;margin-bottom:.5em;" src="<?php echo base_url(); ?>images/add_icon.svg"></a>
									</div>
								</div>
							<?php } else { ?>								
								<div class="control-group col-md-2 col-lg-1 col-sm-2 col-xs-4">
								...
								<div class="control-group col-md-6 col-lg-6 col-sm-6 col-xs-6">
									<div class="controls">
										<label class="control-label color_black"></label>
										<a style="border:none; outline:0;cursor:pointer;" onclick="return GetValidationAndStock('<?php echo site_url(); ?>admin_settings/Admin_Trust_setting/get_add_limit_stock/2')" title="Add Stock"><img style="border:none; outline: 0;margin-top:.8em;margin-bottom:.5em;" src="<?php echo base_url(); ?>images/add_icon.svg"></a>
										 
										<label class="control-label color_black"></label> 
										<a style="border:none; outline:0;cursor:pointer;" onclick="return GetValidationAndEditStock('<?php echo site_url(); ?>admin_settings/Admin_Trust_setting/get_remove_stock/')" title="Remove Stock"><img style="border:none; outline: 0;margin-top:.8em;margin-bottom:.5em;margin-left:20px;" src="<?php echo base_url(); ?>images/minus_icon.svg"></a>
									</div>
								</div>
							<?php }  ?>
						</div>
						...
						<div class="body-inner no-padding table-responsive">
							<table class="table table-bordered table-hover">
								...
								<tbody>
									<!-- edited by adithya added extra if  conditions to other <tr> like in <td>   -->
									<?php foreach($admin_settings_event_seva_limit as $result) {  ?>
										<tr class="row1">
											...
											<?php }?>
											<?php if($admin_settings_event_seva[0]->IS_SEVA != 0) {  ?>
											<?php if($result->TET_IS_SEVA != 0) { ?>
												<td><center><a style="border:none; outline: 0;" onclick="GetAddToHiddenLimit('<?php echo $result->TET_SEVA_DATE ?>','<?php echo $result->TET_SEVA_LIMIT; ?>','<?php echo $result->TET_SL_ID; ?>','<?php echo $result->TET_SEVA_COUNTER; ?>')" role="button" data-toggle="modal" title="Edit"><img style="border:none; outline: 0;" src="<?php echo base_url(); ?>images/edit_icon.svg"></a></center></td>
											<?php } else { ?>
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
                <form action="<?php echo site_url(); ?>admin_settings/Admin_Trust_setting/get_edit_limit/" id="qty" class="form-horizontal" role="form" enctype="multipart/form-data" method="post">
...
<div class="modal fade" id="Stocks" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
                <form action="<?php echo site_url(); ?>admin_settings/Admin_Trust_setting/get_edit_stock/" id="qtyStock" class="form-horizontal" role="form" enctype="multipart/form-data" method="post">
					<div class="form-group">
...
<div class="modal fade" id="removeStockModal">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
    	<div class="modal-header">
          <h4 class="modal-title">Remove Stock Preview</h4>
        </div>
    <div class="modal-footer text-left" style="text-align:left;">
     <label>Are you sure you want to remove  <span id="removeStockVal"></span> stock ?</label>
     <br/>
     <button type="button" style="width: 8%;" class="btn " onclick="document.getElementById('formLimit').submit();">Yes</button>
...
<script>
	...
	function GetSubmitFormLimit() {
		if(document.getElementById('sevalimit').value == "") {
			...
			var url = "<?php echo site_url(); ?>admin_settings/Admin_Trust_setting/get_count_seva_offered";
