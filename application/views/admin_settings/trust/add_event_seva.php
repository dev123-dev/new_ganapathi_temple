<form action="<?php echo site_url(); ?>admin_settings/Admin_Trust_setting/save_event_seva" enctype="multipart/form-data" method="post" accept-charset="utf-8" onsubmit="return field_validation()">
			...
			<!-- START Row -->
				<div class="row-fluid">
					<div class="span12 widget lime">               
						<h3 class="registr"><span class="icon icone-crop"></span>Add Event Seva</h3>                 
					</div>           
				</div>	
				<br/>
				<section class="body">
					<div class="body-inner">    
						<div class="row form-group">
							<div class="control-group col-md-6 col-lg-6 col-sm-6 col-xs-12">
								...
								<div class="controls">
									<input name="event_name" id="event_name" type="text" class="span6  form-control register_form" value="<?php echo $admin_settings_events[0]->TET_NAME; ?>" readonly>
									<input type="hidden" name="event_Id" id="event_Id" value="<?php echo $admin_settings_events[0]->TET_ID; ?>">
						...
						<div class="row form-group">
							...
							<div class="control-group col-md-3 col-lg-3 col-sm-3 col-xs-12">
								...
								<div class="controls">
									<input type="checkbox" value="1" name="qty_checker" id="qty_checker" style="width:20px;height:20px;margin:0;">
									<span class="form-input-info positioning" style="color:#FF0000"></span>
								</div>
							</div>
