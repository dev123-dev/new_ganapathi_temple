<form action="<?php echo site_url(); ?>admin_settings/Admin_Trust_setting/save_bank_details" enctype="multipart/form-data" method="post" accept-charset="utf-8" onsubmit="return field_validation()">
			...
			<!-- START Row -->
				<div class="row-fluid">
					<div class="span12 widget lime">               
						<h3 class="registr"><span class="icon icone-crop"></span>Add Bank</h3>                 
					</div>           
				</div>	
				<br/>
				<section class="body">
					<div class="body-inner">    
						<div class="row form-group">		
							<div class="control-group col-md-3 col-lg-3 col-sm-3 col-xs-12">
								...
								<div class="controls">
									<input name="account_no" id="account_no" type="text" class="span6  form-control register_form" value="">
							...
							<div class="control-group col-md-3 col-lg-3 col-sm-3 col-xs-12">
								...
								<div class="controls">
									<input name="bank_name" id="bank_name" type="text" class="span6  form-control register_form" value="">
									<span class="form-input-info positioning" style="color:#FF0000"></span>
								</div>
							</div>
							...
							<div class="control-group col-md-3 col-lg-3 col-sm-3 col-xs-12">
								...
								<div class="controls">
									<input name="branch_name" id="branch_name" type="text" class="span6  form-control register_form" value="">
									<span class="form-input-info positioning" style="color:#FF0000"></span>
								</div>
							</div>
							...
							<div class="control-group col-md-3 col-lg-3 col-sm-3 col-xs-12">
								...
								<div class="controls">
									<input name="ifsc_code" id="ifsc_code" type="text" class="span6  form-control register_form" value="">
									<span class="form-input-info positioning" style="color:#FF0000"></span>
								</div>
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="control-group col-md-6 col-lg-6 col-sm-6 col-xs-12 text-left">
								...
								<button type="button" class="btn btn-default btn-md" onclick="golist('admin_settings/Admin_Trust_setting/bank_setting');"><strong>CANCEL</strong></button>
							</div>
						</div>
...
<script>
	...
	function field_validation() {
		...
		if (document.getElementById("account_no").value != "") {
			$('#account_no').css('border-color', "#000000");
		} else {
			$('#account_no').css('border-color', "#FF0000");
			++count;
		}
