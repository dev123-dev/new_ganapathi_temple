<form action="<?php echo site_url(); ?>admin_settings/Admin_Trust_setting/update_bid_range" enctype="multipart/form-data" method="post" accept-charset="utf-8" onsubmit="return field_validation()">
			...
			<!-- START Row -->
				<div class="row-fluid">
					<div class="span12 widget lime">               
						<h3 class="registr"><span class="icon icone-crop"></span>Edit Bid Range</h3>                 
					</div>           
				</div>	
				<br/>
				<section class="body">
					<div class="body-inner">    
						<div class="row form-group">							
								...
								<div class="controls">
									<select onChange="setSaree();" class="form-control register_form" id="item" name="item" disabled>		
										...
										<?php foreach($auction_item as $result) { ?>
											<?php if($bid_range[0]->IBR_AI_ID == $result->AI_ID) { ?>
									...
									<!--HIDDEN FIELD -->
									<input name="itemid" id="itemId" type="hidden" value="<?php echo $bid_range[0]->IBR_AI_ID; ?>">
								</div>
							</div>
									...
									<div class="controls">
										<select class="form-control register_form" id="item_category" name="item_category" disabled>		
											...
											<?php foreach($auction_category as $result) { ?>
												<?php if($bid_range[0]->IBR_AIC_ID == $result->AIC_ID) { ?>
							...
							<div class="control-group col-md-2 col-lg-2 col-sm-2 col-xs-12">
								<label class="control-label color_black">Bid Value(Range Start) <span style="color:#800000;">*</span></label>
								<div class="controls">
									<input name="bid_value_from" id="bid_value_from" type="text" class="span6  form-control register_form" value="<?php echo $bid_range[0]->ITEM_FROM_PRICE; ?>">
									<span class="form-input-info positioning" style="color:#FF0000"></span>
								</div>
							</div> 
							
							<div class="control-group col-md-2 col-lg-2 col-sm-2 col-xs-12">
								<label class="control-label color_black">Bid Value(Range End) <span style="color:#800000;">*</span></label>
								<div class="controls">
									<input name="bid_value_to" id="bid_value_to" type="text" class="span6  form-control register_form" value="<?php echo $bid_range[0]->ITEM_TO_PRICE; ?>">
									<span class="form-input-info positioning" style="color:#FF0000"></span>
								</div>
							</div> 
							
							<div class="control-group col-md-2 col-lg-2 col-sm-2 col-xs-12">
								<label class="control-label color_black">Min. Bid Value <span style="color:#800000;">*</span></label>
								<div class="controls">
									<input name="bid_value" id="bid_value" type="text" class="span6  form-control register_form" value="<?php echo $bid_range[0]->MIN_BID_VALUE; ?>">
									<span class="form-input-info positioning" style="color:#FF0000"></span>
								</div>
							</div> 
						</div>
						...
						<!--HIDDEN FIELD -->
						<input name="IBR_ID" id="IBR_ID" type="hidden" value="<?php echo $bid_range[0]->IBR_ID; ?>">
