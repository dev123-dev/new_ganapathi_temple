					...
					<section class="body">						
						...
						<div class="body-inner no-padding table-responsive">
							<table class="table table-bordered table-hover">
								...
								<tbody>
									<?php foreach($print_event as $result) { ?>
										<tr class="row1">
											<td><a style="color:#800000;" onclick="show_event('<?php echo $result->ET_RECEIPT_ID; ?>')"><?php echo $result->ET_RECEIPT_NO; ?></a></td>
...
<div id="myModalEvent" class="modal fade" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content" style="padding-bottom:1em;">
			...
			<div class="modal-body" id="eventdet" style="overflow-y: auto;max-height: 330px;">
			</div>
		</div>
	</div>
</div> 
<script>
	function show_event(id){
		var c_url ="<?php echo site_url(); ?>admin_settings/Admin_setting/ViewEvent";
		$.ajax({
			url: c_url,
			data: {'id':id},          
			type: 'post', 
