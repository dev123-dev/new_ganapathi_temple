					...
					<section class="body">
						<div class="row form-group"> 
							<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 no-pad">
								<h3 style="font-weight:600">Event Cheque Reconciliation</h3>
							</div>
						</div>
						<form action="<?php echo site_url(); ?>admin_settings/Admin_setting/SearchchequeRemmittance" id="chequeNumberSubmit" enctype="multipart/form-data" 	 method="post" accept-charset="utf-8">
							<div class="row form-group" style="margin-top:-0.8em;"> 
								...
								<a style="text-decoration:none;cursor:pointer;pull-right;" href="<?=site_url()?>admin_settings/Admin_setting/chequeRemmittance" title="Refresh"><img style="width:24px;height:24px;margin-top:10px;" title="Refresh" src="<?=site_url();?>images/refresh.svg"/></a>
								</div>
							</div>
						</form>
											...
											<?php if(isset($_SESSION['Authorise'])) { ?>
												<td class="text-center" width="30%">
													<?php if($result->PAYMENT_STATUS == "Pending") { ?>
														<a style="border:none; outline: 0;" onClick="callModal('<?=$name; ?>','<?=$amt; ?>','<?=$chequeNo; ?>','<?=$chequeDate; ?>','<?=$bank; ?>','<?=$branch; ?>','<?=$receiptId; ?>','<?=$voucherNo; ?>','<?=$voucherType; ?>');" title="Approve Cheque" ><img style="border:none; outline: 0;" width="24px" height="24px" src="<?php echo	base_url(); ?>images/check_icon.svg"></a>
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 style="font-weight:600;" class="modal-title text-center">Cheque Reconciliation</h4>
			</div>
...
<div class="modal fade" id="chequeReplaceModal" role="dialog">
  ...
  <form id="submitForm" action="<?php echo site_url(); ?>admin_settings/Admin_setting/edit_chequeRemmittance/" id="chequeRemmittanceForm" class="form-group" role="form" enctype="multipart/form-data" method="post">
    ...
    <form id="submitReplaceForm" action="<?php echo site_url(); ?>finance/replaceEventChequeDetails" class="form-group" role="form" enctype="multipart/form-data" method="post">	
...
<script>
	...
	function callModal(name, amt, chequeNo, chequeDated, bank, branch, receiptId,voucherNo,voucherType) {
