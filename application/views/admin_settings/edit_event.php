<form action="<?php echo site_url(); ?>admin_settings/Admin_setting/update_event/<?php if($this->session->userdata('EtId') != "") { echo $this->session->userdata('EtId');  } else { echo $admin_settings_events[0]->ET_ID; } ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8" onsubmit="return field_validation()">
					...
					<div class="body-inner">    
						<div class="row form-group">
							<div class="control-group col-md-6 col-lg-6 col-sm-6 col-xs-12">
								...
								<div class="controls">
									<input name="event_name" id="event_name" type="text" class="span6  form-control register_form" value="<?php if($this->session->userdata('EtName') != "") { echo $this->session->userdata('EtName');  } else {  echo $admin_settings_events[0]->ET_NAME; } ?>">
							...
							<div class="control-group col-md-2 col-lg-2 col-sm-2 col-xs-12">
								...
								<div class="controls">
									<div class="input-group input-group-sm">
										<input name="todayDateFrom" id="todayDateFrom" type="text" value="<?php if($this->session->userdata('EtFrom') != "") { echo $this->session->userdata('EtFrom');  } else { echo $admin_settings_events[0]->ET_FROM_DATE_TIME; } ?>" class="form-control todayDateFrom" placeholder="dd-mm-yyyy">
							...
							<div class="control-group col-md-2 col-lg-2 col-sm-2 col-xs-12">
								...
								<div class="controls">
									<div class="input-group input-group-sm">
										<input name="todayDateTo" id="todayDateTo" type="text" value="<?php if($this->session->userdata('EtTo') != "") { echo $this->session->userdata('EtTo');  } else { echo $admin_settings_events[0]->ET_TO_DATE_TIME; } ?>" class="form-control todayDateTo" placeholder="dd-mm-yyyy">
										<div class="input-group-btn">
							...
							<div class="control-group col-md-2 col-lg-2 col-sm-2 col-xs-12">
								...
								<div class="controls">
									<select class="form-control register_form" id="event_active" name="event_active">		
										<?php if($admin_settings_events[0]->ET_ACTIVE == 0) { ?>
