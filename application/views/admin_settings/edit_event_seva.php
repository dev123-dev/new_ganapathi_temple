<form action="<?php echo site_url(); ?>admin_settings/Admin_setting/update_event_seva" enctype="multipart/form-data" method="post" accept-charset="utf-8" onsubmit="return field_validation()">
					...
					<div class="body-inner">    
						<div class="row form-group">
							<div class="control-group col-md-6 col-lg-6 col-sm-6 col-xs-12">
								...
								<div class="controls">
									<input name="event_name" id="event_name" type="text" class="span6  form-control register_form" value="<?php echo $admin_settings_event_seva[0]->ET_NAME; ?>" readonly>
									<input type="hidden" name="event_Id" id="event_Id" value="<?php echo $admin_settings_event_seva[0]->ET_ID; ?>">
							...
							<div class="control-group col-md-3 col-lg-3 col-sm-3 col-xs-12">
								...
								<div class="controls">
									<input name="seva_price" id="seva_price" type="text" class="span6  form-control register_form" onkeyup="checkPriceVal(event)" value="<?php echo $admin_settings_event_seva[0]->ET_SEVA_PRICE; ?>">
									<span class="form-input-info positioning" style="color:#FF0000"></span>
								</div>
							</div>
							<div class="control-group col-md-3 col-lg-3 col-sm-3 col-xs-12">
								...
								<div class="controls">
									<select class="form-control register_form" id="seva_active" name="seva_active">		
										<?php if($admin_settings_event_seva[0]->ET_SEVA_ACTIVE == 0) { ?>
						...
						<div class="row form-group">
							<div class="control-group col-md-6 col-lg-6 col-sm-6 col-xs-12">
								...
								<div class="controls">
									<input name="seva_name" id="seva_name" type="text" class="span6  form-control register_form" value="<?php echo $admin_settings_event_seva[0]->ET_SEVA_NAME; ?>">
									<span class="form-input-info positioning" style="color:#FF0000"></span>
								</div>
							</div>  
							<div class="control-group col-md-3 col-lg-3 col-sm-3 col-xs-12">
							<label class="control-label color_black">Quantity Checker</label>
								<div class="controls">
									<?php if($admin_settings_event_seva[0]->ET_SEVA_QUANTITY_CHECKER == 0) { ?>
						...
						<div class="row form-group">
							<div class="control-group col-md-6 col-lg-6 col-sm-6 col-xs-12">
								...
								<div class="controls">
									<textarea rows="5" name="seva_desc" id="seva_desc" style="resize: none;" class="span6 form-control register_form"><?php echo $admin_settings_event_seva[0]->ET_SEVA_DESC; ?></textarea>
									<span class="form-input-info positioning" style="color:#FF0000"></span>
								</div>
							</div>
							<div class="control-group col-md-3 col-lg-3 col-sm-3 col-xs-12">
						...
						<!--HIDDEN FIELDS -->
						<input type="hidden" name="seva_id" id="seva_id" value="<?php echo $admin_settings_event_seva[0]->ET_SEVA_ID;?>">
						<input type="hidden" name="price" id="price" value="<?php echo $admin_settings_event_seva[0]->ET_SEVA_PRICE;?>">
						<input type="hidden" name="price_id" id="price_id" value="<?php echo $admin_settings_event_seva[0]->ET_SEVA_PRICE_ID;?>">
					</div>
			   </section>
		  </div>
		</div>
