					...
					<section class="body">
						...
						<div class="body-inner no-padding table-responsive">
							<table class="table table-bordered table-hover">
								...
								<tbody>
									<?php //print_r($admin_settings_group_rights); 
									foreach($admin_settings_group_rights as $result) {?>
										<tr class="row1">
											<!-- below condition added by adithya  -->
										...
										<?php }else{?>
											...
											<?php if((isset($_SESSION['Active_Deactive']) || isset($_SESSION['Edit']))) { ?>
												<td class="text-center" width="30%">
													<a style="border:none; outline: 0;" href="<?php echo site_url(); ?>admin_settings/Admin_setting/edit_group_rights/<?php echo $result->GROUP_ID; ?>" title="Edit Group" ><img style="border:none; outline: 0;" src="<?php echo	base_url(); ?>images/edit_icon.svg"></a>&nbsp;&nbsp;
													<?php if($result->GROUP_ACTIVE == "1") { ?>
