<form action="<?php echo site_url(); ?>admin_settings/Admin_setting/save_bank_details" enctype="multipart/form-data" method="post" accept-charset="utf-8" onsubmit="return field_validation()">
