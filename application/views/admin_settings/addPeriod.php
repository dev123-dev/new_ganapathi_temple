			...
			<div class="container-fluid container">
				...
				<div class="row form-group">
					<div class="col-lg-10 col-md-10 col-sm-10 col-xs-8">               
						<h3><span class="icon icone-crop"></span>Add Shashwath Period:</h3> 
					</div>
					...
					<form id = "periodForm" action="<?php echo site_url(); ?>Shashwath/add_period_details/" enctype="multipart/form-data" method="post" accept-charset="utf-8">
									...
									<div class="row form-group">
										<div class="control-group col-md-4 col-lg-4 col-sm-4 col-xs-8">
											...
											<div class="controls" style= "padding-bottom:30px">
												<input type="text" class="form-control form_contct2" id="periodN" placeholder="" name="pname" autofocus />	
											</div>
										</div> 
										<div class="control-group col-md-3 col-lg-3 col-sm-3 col-xs-5">
											<label class="control-label color_black">Period </label>
											<input type="number" min='0' class="form-control form_contct2" id="period" placeholder="" name="period"/>
										</div>
									</div>
								</div>
