<form action="<?php echo site_url(); ?>admin_settings/Admin_setting/save_event" enctype="multipart/form-data" method="post" accept-charset="utf-8" onsubmit="return field_validation()">
					...
					<div class="body-inner">    
						...
						<div class="row form-group">
							<div class="control-group col-md-6 col-lg-6 col-sm-6 col-xs-12 text-left">
								...
								<button type="button" class="btn btn-default btn-md" onclick="golist('admin_settings/Admin_setting/events_setting');"><strong>CANCEL</strong></button>
							</div>
						</div>
