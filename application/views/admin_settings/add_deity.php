<form action="<?php echo site_url(); ?>admin_settings/Admin_setting/save_deity" enctype="multipart/form-data" method="post" accept-charset="utf-8" onsubmit="return field_validation()">
			...
			<!-- START Row -->
				<div class="row-fluid">
					<div class="span12 widget lime">               
						<h3 class="registr"><span class="icon icone-crop"></span>Add Deity</h3>                 
					</div>           
				</div>	
				<br/>
				<section class="body">
					<div class="body-inner">    
						<div class="row form-group">							
							<div class="control-group col-md-6 col-lg-6 col-sm-6 col-xs-12">
								...
								<div class="controls">
									<input name="deity_name" id="deity_name" type="text" class="span6  form-control register_form" value="">
