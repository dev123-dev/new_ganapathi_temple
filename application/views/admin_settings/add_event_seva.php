<form action="<?php echo site_url(); ?>admin_settings/Admin_setting/save_event_seva" enctype="multipart/form-data" method="post" accept-charset="utf-8" onsubmit="return field_validation()">
					...
					<div class="body-inner">    
						<div class="row form-group">
							<div class="control-group col-md-6 col-lg-6 col-sm-6 col-xs-12">
								...
								<div class="controls">
									<input name="event_name" id="event_name" type="text" class="span6  form-control register_form" value="<?php echo $admin_settings_events[0]->ET_NAME; ?>" readonly>
									<input type="hidden" name="event_Id" id="event_Id" value="<?php echo $admin_settings_events[0]->ET_ID; ?>">
