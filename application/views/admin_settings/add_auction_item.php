<form action="<?php echo site_url(); ?>admin_settings/Admin_setting/save_auction_item" enctype="multipart/form-data" method="post" accept-charset="utf-8" onsubmit="return field_validation()">
