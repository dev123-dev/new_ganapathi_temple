<form action="<?php echo site_url(); ?>admin_settings/Admin_setting/update_user" enctype="multipart/form-data" method="post" accept-charset="utf-8" onsubmit="return field_validation()">
