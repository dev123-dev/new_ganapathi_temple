						...
						<div class="row form-group"> 
							...
							<div class="col-md-2 col-lg-2 col-sm-2 col-xs-2 text-right">
								<?php if(isset($_SESSION['Add'])) { ?>
									<a style="border:none; outline:0;" href="<?php echo site_url(); ?>admin_settings/Admin_setting/add_user" title="Add User"><img style="border:none; outline: 0;margin-top:1.4em;margin-bottom:.5em;" src="<?php echo base_url(); ?>images/add_icon.svg"></a>
								<?php } ?>
							</div>
						</div>
											...
											<?php if((isset($_SESSION['Edit']) && isset($_SESSION['Active_Deactive']))) { ?>
													<td class="text-center" width="45%">
														<?php if($this->session->userdata('userGroup') == "6" || $this->session->userdata('userGroup') == "1") { ?>
															<a style="border:none; outline: 0;" href="<?php echo site_url(); ?>admin_settings/Admin_setting/change_password/<?php echo $result->USER_ID; ?>" title="Change Password" ><img style=" width:24px; height:24px;border:none; outline: 0;" src="<?php echo	base_url(); ?>images/Change_pswd.svg"></a>
														<?php } ?>
														<a style="border:none; outline: 0;" href="<?php echo site_url(); ?>admin_settings/Admin_setting/edit_user/<?php echo $result->USER_ID; ?>" title="Edit User Details" ><img style="border:none; outline: 0;" src="<?php echo	base_url(); ?>images/edit_icon.svg"></a>
