...
(function ($) {
    ...
    var eCalendar = function (options, object) {
        ...
        var mouseOverEvent = function () {
            ...
            document.querySelector('div.c-event-item[data-event-day="' + d + '"]').scrollIntoView();
        ...
        function print() {
            ...
            for (var i = 0; i < settings.events.length; i++) {
                ...
                if (d.getMonth() == dMonth && d.getFullYear() == dYear) {
                    var date = lpad(d.getDate(), 2) + '/' + lpad(d.getMonth() + 1, 2) + '/'+d.getFullYear(); //+ lpad(d.getHours(), 2) + ':' + lpad(d.getMinutes(), 2);
